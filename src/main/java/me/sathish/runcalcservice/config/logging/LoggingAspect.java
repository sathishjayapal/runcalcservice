package me.sathish.runcalcservice.config.logging;
...
public class LoggingAspect {
    ...
    @Pointcut(
            "@within(me.sathish.runcalcservice.config.logging.Loggable) || "
                    + "@annotation(me.sathish.runcalcservice.config.logging.Loggable)")
